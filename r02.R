...
num_array[1] # 배역에서 인덱스 1번 원소를 출력
num_array[3] 
...
num_array[c(1, 5, 10)] # : c() 한수를 인덱스에 사용할 수도 있음
num_array[seq(1, 10, 2)] # : seq() 함수도 인덱스에 사용할 수도 있음
...
# 벡터와 스칼라를 사칙연산(+, -, *, /)를 하면,
# 벡터의 모든 원소에 하나씩 스칼라 값을 사칙연산 하게 된다.

# 벡터와 벡터의 사칙연산은 같은 인덱스에 있는 원소들끼리 사칙연산을 하게 된다.
numbers1 = c(11, 22, 33)
numbers2 = c(10, 20, 30)
numbers1 + numbers2
...
# 함수를 호출할 때 값을 전당해도 되고, 생략해도 되는 파라미터
