...
getwd() # get working directory: 현재 작업 디렉토리(폴더) 이름을 반환
setwd('디렉토리(폴더) 경로)') # set working directory: 현재 작업 디렉토리 변경

exam_csv = read.csv('data/csv_exam.csv')

# 상대 경로(relative path):
#   파일의 위치를 현재 작업 디렉토이에서부터 시작하는 표기법
...
#   절대경로: C:/dev/lab-rdata/csv_exam.csv
